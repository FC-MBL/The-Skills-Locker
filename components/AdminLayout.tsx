      ...
      <div className="min-h-screen bg-slate-100 flex font-sans">
         ...
         <aside className="w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col">
            <div className="h-20 flex items-center px-6 border-b border-slate-800">
               <img src="/logos/FC Logo white.png" alt="FIT College" className="h-10 mr-3" />
               <span className="font-sans text-lg font-bold text-white">Skills Locker Admin</span>
            </div>
            ...
            <nav className="flex-grow py-6 space-y-2 px-3">
               ...
               <Link to="/admin/submissions" className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive('/admin/submissions')}`}>
                  <ClipboardCheck size={20} /> Submissions
               </Link>
