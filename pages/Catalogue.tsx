  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-4xl font-display uppercase text-slate-900 mb-2">Courses</h1>
          <p className="text-slate-500">Browse {publishedItems.length} courses across {DOMAINS.length} branches.</p>
        </div>
