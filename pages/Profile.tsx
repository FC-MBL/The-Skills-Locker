...
import { Button, Input, Label, Card, FileUpload } from '../components/builder/UI';
...
export const Profile: React.FC = () => {
    ...
    const handleSave = () => {
        ...
        if (!formData.name.trim() || !formData.title.trim() || !formData.expertise.trim()) {
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-500">Manage your identity.</p>
                </div>
